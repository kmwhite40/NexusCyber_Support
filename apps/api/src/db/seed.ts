...
async function run() {
  await withSystemContext(async (sql) => {
    ...
    const kbPages: KbPage[] = [
      ...
      { space: 'CLOUD', title: 'Sign in to Azure Government (portal & CLI)', labels: ['azure', 'govcloud', 'cli', 'how-to'], parent: 'Request Azure access (PIM eligible roles)',
