 ...
 *  break the local part or smuggle the identity into a different namespace. */
...
export function planRun(input: PlanInput): Plan {
  ...
  // Belt-and-suspenders: deriveUpn always appends upnDomain literally, so this can't currently
  // fail — it guards against a future change to deriveUpn ever producing an out-of-domain UPN
  // without this planner noticing.
