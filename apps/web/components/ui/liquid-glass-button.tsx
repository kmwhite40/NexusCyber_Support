'use client';
// Vendored 21st.dev component set: Button / LiquidButton / MetalButton.
// (Some utility classes like `bg-linear-to-t` / `inset-shadow-*` are Tailwind v4
// syntax and are harmless no-ops under our v3 setup.)
